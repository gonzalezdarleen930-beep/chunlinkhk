    ...
    <footer className="bg-foreground text-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row md:items-start gap-8">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <div className="text-sm font-bold text-background leading-tight">駿嶺香港有限公司</div>
                <div className="text-xs opacity-60 leading-tight">CHUN LINK HONG KONG LIMITED</div>
              </div>
            </div>
            <p className="text-sm opacity-70 mb-3">放債人牌照號碼: 1793/2024</p>
            <a
              href="/PrivacyPolicy"
        ...
        <div className="mt-8 pt-6 border-t border-background/20 text-xs opacity-50 text-center">
          © Copyright 2024 chunlinkhk. All Rights Reserved.
        </div>
      </div>
