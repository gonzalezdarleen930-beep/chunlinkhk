      ...
      <main className="flex-1 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>富毅信貸有限公司("本公司")保留對使用條款的修訂權。本公司可隨時修改、增加及刪減使用條款的內容。任何的內容修訂一經發佈即告生效。本公司建議客人不定期瀏覽此網頁，留意本公司的使用條款有否任何更新，以取得最新資訊。</p>
            ...
            <p>本網站所載各項產品和服務由富毅信貸有限公司按照香港特別行政區放債人牌照在有關司法管轄區合法提供，若任何司法管轄區限制本財務公司分發此等資料，則此等網頁內所載資料並不擬給予位於或居於有關司法管轄區內的人士使用。存取此等網頁的人士須知悉及遵守任何有關限制。</p>
            <div className="border-t border-border pt-4 mt-6">
              <p><strong>放債人牌照號碼：</strong>1841/2025</p>
